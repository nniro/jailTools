...
firewall /tmp/firewallInstructions.txt external openPort fwTestIn fwTestOut $proto 8000;
EOF
...
if ! lift $jtPath start $jail sh /home/singleTest.sh /home/firewallCmd /home/firewallExpectedInstr /home/firewallExpectedIptablesRules 2>/dev/null; then
	echo "Simple openPort $proto test failed"
	exit 1
fi
# simple test end
...
if ! lift $jtPath start $jail sh /home/singleTest.sh /home/firewallCmd /home/firewallExpectedInstr /home/firewallExpectedIptablesRules 2>/dev/null; then
	echo "openPort $proto checks test failed"
	exit 1
fi
# checks test
...
if ! lift $jtPath start $jail sh /home/singleTest.sh /home/firewallCmd /home/firewallExpectedInstr /home/firewallExpectedIptablesRules 2>/dev/null; then
	echo "openPort $proto duplication test failed"
	exit 1
fi
...
if ! lift $jtPath start $jail sh /home/singleTest.sh /home/firewallCmd /home/firewallExpectedInstr /home/firewallExpectedIptablesRules 2>/dev/null; then
	echo "openPort $proto duplication with the instruction file removed test failed"
	exit 1
fi
...
if ! lift $jtPath start $jail sh /home/runTest.sh 2>/dev/null; then
	echo "openPort $proto deletion test failed"
	exit 1
fi
